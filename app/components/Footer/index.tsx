  ...
  return (
    <div className=" relative">
      ...
      <div className='py-8 px-4 border-t border-t-lightblue'>
        <h3 className='text-center text-offwhite'>@2025 - All Rights Reserved by <Link href="https://my-protfolio-ten-omega.vercel.app/" target="_blank">Eslam Elfar</Link></h3>
      </div>
